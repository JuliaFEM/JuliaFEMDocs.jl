...
# ![](example_dcoupling_cylindrical_beam/cylinder.png)
...
datadir = Pkg.dir("JuliaFEMDocumentation", "examples", "applying_point_moment_on_solid_elements_using_distributed_coupling")
mesh = abaqus_read_mesh(joinpath(datadir, "dcoupling_cylinder.inp"))
...
# Making a testset. Comparing results to results from another program.

using FEMBase.Test
@testset "displacement magnitude" begin
u_mag_expected=6.306e-4
if isapprox(u_mag, u_mag_expected, rtol=1e-3)==0
